...
var CPlatforms = Class({
     ...
     */
    isAndroid: function() {
        if (window.device===undefined || CUtils.isEmpty(window.device || null) || window.device.platform===undefined)      return false;
